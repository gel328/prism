...
| Method   | Path                                                  | 说明                                                          |
|----------|-------------------------------------------------------|---------------------------------------------------------------|
| `GET`    | `/api/teams`                                          | 列出当前用户所属的团队                                        |
| `POST`   | `/api/teams`                                          | 创建团队                                                      |
| `GET`    | `/api/teams/:id`                                      | 团队详情 + 当前成员角色 + 有效门槛                            |
| `PATCH`  | `/api/teams/:id`                                      | 更新名称、描述、头像、公开资料开关、`require_2fa`、`require_verified_email` |
| `DELETE` | `/api/teams/:id`                                      | 解散（仅所有者）                                              |
...
| `GET` / `POST` / `DELETE` | `/api/teams/:id/domains[/:domainId]`     | 团队域名                                                      |
